      ...
      <div className="relative w-full max-w-sm fade-in">
        <div className="p-8 bg-zinc-900 border border-zinc-800 rounded-2xl">
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <span className="font-semibold text-zinc-100 tracking-tight">CodeBase</span>
          </div>

          <h1 className="text-2xl font-bold text-center text-zinc-50 mb-1 tracking-tight">Welcome back</h1>
